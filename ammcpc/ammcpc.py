...
class MediaConchPolicyCheckerCommand(object):
    ...
    def __init__(self, policy_file_path=None, policy=None,
    ...
    def check(self, target):
        ...
        try:
            ...
            info, detail = self._get_evt_out_inf_detail(
                policy_checks)
    ...
    def _get_evt_out_inf_detail(self, policy_checks):
        ...
        if policy_checks['mc_version'] == '0.3':
            return self._get_evt_out_inf_detail_v_0_3(
                policy_checks)
